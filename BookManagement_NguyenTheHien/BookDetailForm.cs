    ...
    public partial class BookDetailForm : Form
    {
        ...
        private void BookDetailForm_Load(object sender, EventArgs e)
        {
            ...
            if (SelectedBook != null)
            {
                ...
                txtBookId.Enabled = false; // cấm sửa id khi update 
        ...
        {
            // ta phải tạo ra 1 object book rồi gửi cho sẻvier 
            // Service chuyển cho Repo
            // nhớ check mode " edit hay mode new để gọi đúng hàm repo
            // save xong thì phải close cửa sổ lại
            ...
            Close(); // đóng form cho cả 2 tình huống 
